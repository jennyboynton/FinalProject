...
- I generated another multiple linear regression model to summarize the dataset looking at life expectancy as a function of consumption quantity, continent, time and type of meat; the adjusted R-squared tells me that the graph is 48% fitted to the regression line, meaning 52% of the variability is unexplained. The p-value again tells me it is a statistically significant relationship.
...
- I generated another multiple linear regression model to summarize the dataset looking at life expectancy as a function of consumption quantity, continent, time and type of meat; the adjusted R-squared tells me that the graph is 70% fitted to the regression line, meaning 30% of the variability is unexplained. The p-value again tells me it is a statistically significant relationship.

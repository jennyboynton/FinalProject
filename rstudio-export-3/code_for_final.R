...
#model 5
model_meattype_GDP <- lm(gdpPercap ~ value_lb+continent+TIME+SUBJECT, data = combined_data)
...
# model 6
model_meatsum_GDP <- lm(gdpPercap ~ sum+continent+TIME, data = Totalmeat_vs_lifeExp)
